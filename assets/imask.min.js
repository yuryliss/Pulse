...
currentMaskFlags(flags){var _flags$_beforeTailSta;return{...flags,_beforeTailState:(flags==null?void 0:(_flags$_beforeTailSta=flags._beforeTailState)==null?void 0:_flags$_beforeTailSta.masked)||(flags==null?void 0:flags._beforeTailState)};}}
...
_update(opts){const{enum:_enum,...eopts}=opts;if(_enum){eopts.mask='*'.repeat(_enum[0].length);this.enum=_enum;}
super._update(eopts);}
